...
export default function InsuranceSolutions() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col lg:flex-row">
      ...
      {/* Left Panel */}
      <div className="w-full lg:w-1/3 bg-gray-900 relative overflow-hidden animate-fadeInLeft opacity-0">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 opacity-80" />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-yellow-600 text-7xl md:text-9xl font-bold opacity-20 transform rotate-12">
            LOAN
          </div>
        </div>
        <div className="relative z-10 p-6 sm:p-8 h-full flex flex-col justify-center">
          <h1 className="text-white text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 leading-tight">
            Our Financing Solutions
          </h1>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
            A shadowy flight into the dangerous world of a man who does not
            exist. Flying away on a wing and a prayer. Believe it or not,
            it&apos;s just me.
          </p>
        </div>
      </div>
      ...
      {/* Right Panel */}
      <div className="w-full lg:w-2/3 bg-white px-4 py-10 sm:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 sm:mb-3 group-hover:text-blue-600 transition-colors duration-300">
                  {title}
                </h3>
      ...
      {/* Chat Widget */}
      <div className="fixed bottom-5 right-5 z-50 w-[90%] sm:w-auto">
        <div className="bg-white rounded-lg shadow-lg p-4 mb-3 max-w-xs">
        ...
        <button
          className="bg-blue-600 rounded-full p-3 shadow-lg cursor-pointer hover:bg-blue-700 transition-colors w-fit"
